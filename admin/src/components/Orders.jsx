            ...
            <div className={styles.modalGrid}>
              <div className={styles.modalSection}>
                <h3 className={styles.sectionTitle}>
                  <User className={styles.sectionIcon} /> Customer Information
                </h3>
              ...
              <div className={styles.modalSection}>
                <h3 className={styles.sectionTitle}>
                  <BookOpen className={styles.sectionIcon} /> Order Summary
                </h3>
                <div className={styles.sectionContent}>
              ...
              <div className={styles.modalSection}>
                <h3 className={styles.sectionTitle}>
                  <Edit className={styles.sectionIcon} /> Update Order Status
                </h3>
                <div>
